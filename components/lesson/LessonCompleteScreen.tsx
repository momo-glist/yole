  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <LinearGradient
            colors={[Colors.primaryAccentColor, "#34C759"]}
          ...
          <ThemedText style={styles.completeTitle}>Félicitations</ThemedText>
              ...
              {lessonStats.wrongQuestions.map((question, index) => (
                ...
                >
                  ...
                  <View style={styles.questionContent}>
                    <ThemedText style={styles.questionFrench}>
                      {question.french}
                    </ThemedText>
                    <View style={styles.questionEnglish}>
                      <ThemedText style={styles.questionCharacters}>
                        {question.english.characters}
                      </ThemedText>
                    </View>
                  </View>
                  {question.attempts > 0 && (
