import { ListeningOptions } from "@/constants/CourseData";
...
export default function ListeningMultipleChhoiceMode({
  options,
  selectedOption,
  handleOptionPress,
  isLoading,
      ...
      >
        {options.map((option) => {
          ...
          return (
            ...
            >
              <ThemedText style={styles.optionText}>{option.french}</ThemedText>
            </Pressable>
          );
        })}
      </ScrollView>
