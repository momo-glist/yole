...
export default function IntroScreen() {
  ...
  const mainTextWords: string[] = ["Learn", "English", "the", "right", "way"];
    ...
    <Animated.View style={[styles.viewContainer, menuContentAnimatedStyle]}>
      <View style={styles.logoSection}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.appName}>Yolo</Text>
        </View>
      ...
      <View style={styles.buttonsContainer}>
        ...
        >
          ...
          />
          <Text style={styles.buttonText}>Continué avec Apple</Text>
        </Pressable>
        <Pressable
          style={styles.loginButton}
        ...
        >
          <AntDesign
            ...
            style={styles.appleIcon}
          />
          <Text style={styles.buttonText}>Continué avec Google</Text>
        </Pressable>
        <Pressable
          style={styles.loginButton}
        ...
        >
          ...
          />
          <Text style={styles.buttonText}>Continué avec Email</Text>
        </Pressable>
      </View>
    </Animated.View>
  );
